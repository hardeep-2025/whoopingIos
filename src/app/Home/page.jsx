...
const baseUrl = process.env.NEXT_PUBLIC_BASE_URL;
  ...
  },
  {
    ...
    answer: "Answer Engine Optimization (AEO) is the process of optimizing your website content to appear in AI-generated answers from ChatGPT, Perplexity, Google AI Overviews, and voice search results. Yes — WhoppingSEO offers AEO and GEO (Generative Engine Optimization) as core parts of our advanced 2026 SEO service packages.",
  },
  {
    question: "Does WhoppingSEO work with small businesses?",
    answer: "Absolutely. WhoppingSEO works with businesses of all sizes — from small local businesses in Frisco TX and Dallas TX to large national enterprises across the USA. Our digital marketing packages are fully flexible and scalable to fit any budget while still delivering real measurable growth every single month.",
  },
  {
    question: "Does WhoppingSEO offer a free consultation or audit?",
    answer: "Yes. WhoppingSEO offers a completely free digital marketing audit and consultation for all new clients. We review your website, current rankings, competitor landscape, ad performance, and AI search visibility — then provide honest expert recommendations with absolutely no obligation and no sales pressure.",
  },
...
const services = [
  ...
  return (
  <main className="home">
<div className="banner relative min-h-screen max-h-[700px] overflow-hidden max-[991px]:h-auto max-[991px]:min-h-0 max-[991px]:max-h-none max-[767px]:pt-20">        <div className="absolute inset-0 bg-black/50 -z-10"></div>
...
<div className="textArea mx-auto w-full lg:px-0 max-[400px]:text-center">      
      <div className="MainHeading !text-[35px] !font-bold text-[#FFFFFF]">What Is WhoppingSEO and How Do We Grow Your Business? </div>
          <span className="!para mt-6 flex flex-col text-[18px] leading-[22px]">
            <p>
            WhoppingSEO is a results-driven  <Link href="/services/digital-marketing-services/"  target="_blank"
  rel="noopener noreferrer"><span className="text-[#1A98FF]"> digital marketing agency in USA </span></Link>that combines human expertise with AI-powered tools to help businesses of all sizes grow their online presence, generate consistent leads, and increase revenue.
            </p>
            <p>In 2026 digital marketing has fundamentally changed. Your customers are no longer just typing keywords into Google. They are asking ChatGPT for recommendations. They are getting answers from Google AI Overviews. They are using Perplexity and voice search to find local businesses. If your business is not optimized for all of these platforms — you are invisible to a growing segment of your potential customers every single day.</p>

            <p>That is exactly what we fix at WhoppingSEO. We use<span className="text-[#1A98FF]"> AI-powered SEO, Answer Engine Optimization (AEO) ,  Generative Engine Optimization (GEO) </span>, and advanced paid advertising strategies to make sure your business shows up everywhere your customers are searching — not just traditional Google results.</p>
          </span>
         </div>
          ...
          <div className="noArea mt-[3rem]">
            <div className="numbering flex justify-center gap-[9%] align-middle ">
                <div className="numberDiv flex flex-col py-4 z-40  "  >
                  ...
                  <span className="notext whitespace-nowrap text-center text-[#ffffff] text-[18px] ">Businesses Grown</span>
                </div>
                <div className="numberDiv flex flex-col py-4">
                  <span className="no text-[#1A98FF]">10+</span>
                  <span className="notext whitespace-nowrap text-centerc text-[#ffffff] text-[18px] ">Years of Expertise</span>
                </div>
                <div className="numberDiv flex flex-col py-4">
                  <span className="no text-[#1A98FF]">8M+</span>
                  <span className="notext whitespace-nowrap text-center text-[#ffffff]  text-[18px] ">Keyword Ranking</span>
                </div>
                <div className="numberDiv flex flex-col py-4">
                  <span className="no flex items-center whitespace-nowrap text-[#1A98FF]">4.9 
                 <Star
    size={35}
    fill="#1A98FF"
    stroke="#1A98FF"
  ...
  />
                  ...
                  <span className="notext whitespace-nowrap text-center text-[18px] ">Average Client Rating</span>
                </div>
            </div>
          </div>
        </section>
        ...
        <section className="HoemAboutus">
          ...
          <div className="textArea">
            <h2 className="MainHeading text-[#ffffff] max-[400px]:text-center text-[35px]! font-bold!">
              How <span className="text-[#1A98FF]">WhoppingSEO {" "}</span> 
             Turns Strategy Into Business Growth — Our 5 Step Process
            </h2>

            <span className="para mt-6 text-[#ffffff] flex flex-col max-[400px]:text-center">
              <p>
               We believe in complete transparency. Here is exactly how we work with every new client from the very first conversation to consistent monthly growth:
              </p>
            </span>
          </div>
  ...
  <div className="Faq  bg-black  !py-[4rem]">
    <Container>
          ...
          <div className="textArea flex flex-col item-center justify-center">
            <h2 className="MainHeading text-center text-[#ffffff] !text-[35px] !font-bold ">Frequently Asked Questions About WhoppingSEO</h2>
